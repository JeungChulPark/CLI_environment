...
static const _ScanMatchingOdometryDebug_type_support_symbol_names_t _ScanMatchingOdometryDebug_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_graph_slam, msg, ScanMatchingOdometryDebug)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hdl_graph_slam, msg, ScanMatchingOdometryDebug)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hdl_graph_slam, msg, ScanMatchingOdometryDebug)() {
  return &::hdl_graph_slam::msg::rosidl_typesupport_c::ScanMatchingOdometryDebug_message_type_support_handle;
}
