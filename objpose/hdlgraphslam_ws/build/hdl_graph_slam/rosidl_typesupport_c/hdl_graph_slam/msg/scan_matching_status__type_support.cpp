...
static const _ScanMatchingStatus_type_support_symbol_names_t _ScanMatchingStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_graph_slam, msg, ScanMatchingStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hdl_graph_slam, msg, ScanMatchingStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hdl_graph_slam, msg, ScanMatchingStatus)() {
  return &::hdl_graph_slam::msg::rosidl_typesupport_c::ScanMatchingStatus_message_type_support_handle;
}
