    ...
    def utm(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'utm' field must be of type 'bool'"
        self._utm = value
...
class SaveMap_Event(metaclass=Metaclass_SaveMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<hdl_graph_slam/SaveMap_Request, 1>',
        'response': 'sequence<hdl_graph_slam/SaveMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['hdl_graph_slam', 'srv'], 'SaveMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['hdl_graph_slam', 'srv'], 'SaveMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from hdl_graph_slam.srv import SaveMap_Request
    ...
    def response(self, value):
        if self._check_fields:
            from hdl_graph_slam.srv import SaveMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from hdl_graph_slam.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from hdl_graph_slam.srv._save_map import SaveMap_Request as Request
    from hdl_graph_slam.srv._save_map import SaveMap_Response as Response
    from hdl_graph_slam.srv._save_map import SaveMap_Event as Event
