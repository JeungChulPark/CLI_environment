...
class Metaclass_LoadGraph_Event(type):
    """Metaclass of message 'LoadGraph_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__load_graph__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__load_graph__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__load_graph__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__load_graph__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__load_graph__event
...
class LoadGraph_Event(metaclass=Metaclass_LoadGraph_Event):
    """Message class 'LoadGraph_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<hdl_graph_slam/LoadGraph_Request, 1>',
        'response': 'sequence<hdl_graph_slam/LoadGraph_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['hdl_graph_slam', 'srv'], 'LoadGraph_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['hdl_graph_slam', 'srv'], 'LoadGraph_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from hdl_graph_slam.srv import LoadGraph_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, LoadGraph_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'LoadGraph_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from hdl_graph_slam.srv import LoadGraph_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, LoadGraph_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'LoadGraph_Response'"
...
class Metaclass_LoadGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from hdl_graph_slam.srv import _load_graph
            ...
            if _load_graph.Metaclass_LoadGraph_Event._TYPE_SUPPORT is None:
                _load_graph.Metaclass_LoadGraph_Event.__import_type_support__()


class LoadGraph(metaclass=Metaclass_LoadGraph):
    from hdl_graph_slam.srv._load_graph import LoadGraph_Request as Request
    from hdl_graph_slam.srv._load_graph import LoadGraph_Response as Response
    from hdl_graph_slam.srv._load_graph import LoadGraph_Event as Event
