...
static const _ScanMatchingStatus_type_support_symbol_names_t _ScanMatchingStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hdl_graph_slam, msg, ScanMatchingStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hdl_graph_slam, msg, ScanMatchingStatus)),
  }
};
...
{
  return &::hdl_graph_slam::msg::rosidl_typesupport_cpp::ScanMatchingStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hdl_graph_slam, msg, ScanMatchingStatus)() {
  return get_message_type_support_handle<hdl_graph_slam::msg::ScanMatchingStatus>();
}
