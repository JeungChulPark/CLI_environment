...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/Users/user/objpose/hdlgraphslam_ws/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/Users/user/micromamba/envs/hdl_graph_slam_jazzy/bin/python3.12"
