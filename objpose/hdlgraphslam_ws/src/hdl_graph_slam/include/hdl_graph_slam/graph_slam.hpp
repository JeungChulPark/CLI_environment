...
public:
   ...
   * @param num_iterations  maximum optimizer iterations
   * @param min_edges       skip optimization unless the graph has at least this many edges
   *                        (default preserves the original threshold of 10)
   */
  int optimize(int num_iterations, int min_edges = 10);
