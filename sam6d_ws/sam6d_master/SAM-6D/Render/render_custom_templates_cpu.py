...
# Force CPU rendering: Blender 3.3.1 (2022) OptiX kernels stall compiling for the
# new Blackwell GPU (sm_120). CPU is reliable and fast enough for 42 low-sample views.
